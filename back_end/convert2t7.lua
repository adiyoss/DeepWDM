...
cmd:text()
cmd:text('Options:')
cmd:option('-x_filename', 'data/tmp.features', 'the path to the features file')
cmd:option('-y_filename', 'data/tmp.label', 'the path to the labels file')
cmd:option('-input_dim', 39, 'the input dimension size')
cmd:option('-output_dim', 2, 'the output dimension size')
cmd:option('-output_x', 'data/x_icassp.t7', 'the t7 features path')
cmd:option('-output_y', 'data/y_icassp.t7', 'the t7 labels path')
